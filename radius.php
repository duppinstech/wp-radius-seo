...
require_once RADIUS_PATH . 'includes/class-deploy-db-indexes.php';
require_once RADIUS_PATH . 'includes/class-deploy-reconnect.php';
require_once RADIUS_PATH . 'includes/class-deploy-meta-repair.php';
