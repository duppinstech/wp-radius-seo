		...
		wp_localize_script(
			...
			array(
				...
				'i18n'                 => array(
					...
					'intro'                  => __( 'This assistant imports legacy locations, publishes your four service templates with the correct URLs, copies spintax and company details, sets service areas, and can remove old Magic Page landing pages so Deploy can reuse the same URLs. You only need the summary at the end—then open Deploy.', 'radius' ),
					...
					'stepDeployHelp'         => __( 'Available after the five steps above are complete. Review locations and service areas, then open Deploy.', 'radius' ),
