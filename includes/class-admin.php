		...
		wp_localize_script(
			...
			array(
				...
				'i18n'                  => array(
					...
					'deployHttp403'             => __( 'Deploy blocked (HTTP 403) — host or WAF may be blocking admin-ajax.', 'radius' ),
					'deployHttpTimeout'         => __( 'Deploy timed out — proxy or PHP max execution time.', 'radius' ),
					'deployHttp500'             => __( 'Deploy server error — check Radius → Logs and the PHP error log.', 'radius' ),
					'deployWpCritical'          => __( 'WordPress returned a critical error page instead of JSON. Enable WP_DEBUG_LOG or check server PHP logs.', 'radius' ),
					...
					'systemCheckViewDetails'    => __( 'View details', 'radius' ),
					'systemCheckReadyShort'     => __( 'Ready to migrate.', 'radius' ),
					'systemCheckColSetting'     => __( 'Setting', 'radius' ),
					'systemCheckColCurrent'     => __( 'Current', 'radius' ),
					'systemCheckColRecommended' => __( 'Recommended', 'radius' ),
					'systemCheckColStatus'      => __( 'Status', 'radius' ),
			...
			wp_localize_script(
				...
				array(
					...
					'i18n'       => array(
						...
						'trashExtraLandings' => __( 'Trash out-of-scope landings', 'radius' ),
						'trashExtraLandingsConfirm' => __( 'Move landing pages for places outside deploy scope to the Trash? Each trashed URL will 301 redirect to your service area index (e.g. /service-area/).', 'radius' ),
						'trashExtraLandingsRunning' => __( 'Trashing landings…', 'radius' ),
